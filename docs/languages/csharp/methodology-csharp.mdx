...
public class CustomHttpClient : ISpeakeasyHttpClient
{
    ...
    /// <span className="returns">The value of the TResult parameter contains the HTTP response message.</span>
    ...
    /// <span className="returns">The value of the TResult parameter contains the cloned HTTP request message.</span>
