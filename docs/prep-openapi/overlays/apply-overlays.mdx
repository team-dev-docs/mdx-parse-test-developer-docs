...
<div className="Screenshot" data-variant="cli" data-docs={true}>
  ![Screenshot of the terminal after running speakeasy configure sources.](./assets/overlays-1.png)
</div>
...
<div className="Screenshot" data-variant="cli" data-docs={true}>
  ![Screenshot of the terminal prompting user to add an overlay.](./assets/overlays-2.png)
</div>
...
<div className="Screenshot" data-variant="cli" data-docs={true}>
  ![Screenshot of the terminal showing a succesful overlay application.](./assets/overlays-3.png)
</div>
...
<div className="Screenshot" data-variant="cli" data-docs={true}>
  ![Screenshot of the terminal showing completed setup.](./assets/overlays-4.png)
</div>
