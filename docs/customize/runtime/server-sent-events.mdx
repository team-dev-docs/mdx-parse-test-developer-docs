...
To implement SSE in generated SDKs, model an API endpoint that serves an event
...
<div data-callout data-title="IMPORTANT" data-variant="info">
...
<div data-callout data-title="NOTE" data-variant="info">
  Across all of these examples, the schema for the events only ever specifies
