...
<div data-callout data-title="WARN" data-variant="info">
...
- `errors` refers to the models generated for schemas referenced in error status code responses.
...
<div data-callout data-title="CAUTION" data-variant="warning">
...
<div data-tabs data-items='["Typescript", "Python", "Go", "C#", "Unity"]'>
