...
import { Callout } from '~~/components'; import { LanguageTestingGrid } from "~~/features/shared/recipes";
...
Speakeasy's test generation uses the [Arazzo Specification](/openapi/arazzo) to generate tests for your API. Arazzo is a simple, human-readable, and extensible specification for defining API workflows. With Arazzo powering test generation, Speakeasy provides the following features:
