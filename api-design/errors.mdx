...
2. programs - so that program behavior can be correctly triggered of the error.
...
professionals and use existing standards: [RFC 9457 - Problem Details for HTTP
APIs](https://www.rfc-editor.org/rfc/rfc9457.html). This is being used by more
and more API teams.
