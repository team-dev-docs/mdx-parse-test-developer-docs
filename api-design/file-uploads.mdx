...
service that handles file uploads. It's up to you, but it's good to split up
...
This is common because it's harder for the web application to access the raw
