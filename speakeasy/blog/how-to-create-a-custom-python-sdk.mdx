...
<div className="Callout" data-title="Python Versions" data-variant="warning">
...
<div className="Callout" data-title="Python Packaging" data-variant="warning">
...
<div className="Callout" data-title="PyPI API Tokens" data-variant="warning">
