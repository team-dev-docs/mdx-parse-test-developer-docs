...
<div className="Tabs" data-items="['TypeScript','Java']">
<div className="TabsTab">
...
<div className="Tabs" data-items="['Typescript']">
...
<div className="Tabs" data-items="['TypeScript', 'Typescript-Axios (v1)', 'Python', 'Go', 'Java', 'C#']">
