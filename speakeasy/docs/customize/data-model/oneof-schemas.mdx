...
<div className="Tabs" data-items="['TypeScript', 'Go', 'Python', 'C#', 'Java']">
...
public class FetchPetRequestBody {
     ...
     * <ul>
     * <span className="li">{@code java.lang.String}</span>
     * <span className="li">{@code long}</span>
     * <span className="li">{@code pet.store.simple.models.shared.Pet}</span>
     * </ul>
     *
