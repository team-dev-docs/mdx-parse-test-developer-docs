...
image: "/media/release-python-v2.png"
date: 2024-07-24
authors:
...
tags:
  - Product Updates
featured_image: "/media/release-python-v2.png"
is_featured: true
---
...
<div className="Callout" data-title="Beta Availability" data-variant="success">
  Now in beta! All new Python SDKs will use the new generator by default. If
  you'd like to try it upgrade an existing Python SDK in production, check out
  our [migration guide](/docs/python-migration).
</div>
