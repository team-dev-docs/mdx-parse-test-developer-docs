...
<div className="Testimonial"
  data-variant="dark"
  data-avatar="/media/quote-headshots/roy-pereira.png"
  data-quoted="Roy Pereira, Unified.to CEO & Co-Founder"
>
...
<div className="Testimonial" data-variant="dark">
  “To ensure we would be able to run the code-generation process within
  ourContinuous Integration(CI) pipeline, we needed to use
  aDockerisedversion ofopenapi-generator-cli(the coordination of which was a
  complex process).”
</div>
