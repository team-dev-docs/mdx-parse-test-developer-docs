...
<div className="IconGrid">TypescriptFrameworkGuidesData</div>

<div className="IconGrid">PythonFrameworkGuidesData</div>

<div className="IconGrid">GoFrameworkGuidesData</div>

<div className="IconGrid">JavaFrameworkGuidesData</div>

<div className="IconGrid">PHPFrameworkGuidesData</div>
