...
When using Pydantic with FastAPI, you can define your API endpoints and operations directly in your FastAPI application. [FastAPI automatically generates the OpenAPI schema for your API](./fast-api/fastapi.mdx), including the `paths` section.
...
<div className="ScrollyCoding" data-classname="ch-scrollycoding-full-height ch-scrollycoding-force-focus-scroll">
