...
<div className="mt-10 flex items-center justify-center">
  <div className="YouTube" data-videoid="dn5U_pidRw0"></div>
</div>
...
Scribe is a robust documentation solution for PHP APIs. It helps you generate comprehensive human-readable documentation from your Laravel/Lumen/Dingocodebase.That includes HTML documentation, code samples, Postman Collections, and most importantly in our case, OpenAPI specifications.
